<template>
  <v-app dark>
    ...
    <v-toolbar class="toolbar" color="red">
      <v-toolbar-title class="white--text flex">
        Our resources are solely going to development on Grid v3. Please make sure to <a target="_blank" href="https://forum.threefold.io/t/farming-migration-grid-v2-v3/2143" class="text-white">migrate</a> your farm/nodes.
        You can find the grid 3 explorer <a target="_blank" href="https://explorer3.grid.tf/" class="text-white">here</a>.
        </v-toolbar-title>
    </v-toolbar>
